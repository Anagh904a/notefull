...
function applySortFilter() {
  ...
  if (sortValue === "note") {
    ...
    document.getElementById("noListsMessage").classList.add("hidden");
...
document.getElementById('ubtn').style.display = "flex";
  ...
  itemText.querySelector("h2").textContent = "Create a new Note";
...
function openNote(index) {
  ...
  itemText.querySelector("h2").textContent = "Manage your Note";
document.getElementById('ubtn').style.display = "flex";
